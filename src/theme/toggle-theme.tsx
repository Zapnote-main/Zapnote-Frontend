...
const Skiper4 = () => {
  ...
  return (
    <div className="fixed top-4 right-4 z-50 flex flex-col items-center justify-center gap-5">
      <motion.div
...
export const ThemeToggleButton1 = ({
  ...
  return (
    <button
      type="button"
      className={cn(
        "rounded-full bg-black text-white transition-all duration-300 active:scale-95 dark:bg-white dark:text-black",
        className,
      )}
