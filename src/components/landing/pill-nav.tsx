...
const PillNav: React.FC<PillNavProps> = ({
  ...
  const effectiveBaseColor = isDark ? baseColor : '#ffffff';
  const effectivePillColor = isDark ? pillColor : '#000000';
  const effectiveHoveredPillTextColor = isDark ? hoveredPillTextColor : '#000000';
  const effectivePillTextColor = isDark ? (pillTextColor ?? baseColor) : '#ffffff';
  ...
  return (
    <motion.div
      ...
      className="fixed top-4 z-1000 w-full left-0 md:w-auto md:left-1/2 md:-translate-x-1/2"
    >
      <nav
          ...
          >
            {items.map((item, i) => {
              ...
              const pillStyle: React.CSSProperties = {
                background: isActive ? (isDark ? '#333333' : '#f0f0f0') : effectivePillColor,
                color: isActive ? (isDark ? effectivePillTextColor : '#000000') : 'var(--pill-text, var(--base, #000))',
